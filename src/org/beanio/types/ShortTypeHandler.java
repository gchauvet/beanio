...
/**
 * A type handler implementation for the <code>Short</code> class.  If <code>pattern</code>
 * is set, a <code>DecimalFormat</code> is used to parse and format the value.  Otherwise,
 * the value is parsed and formatted using the <code>Short</code> class.
 * 
 * @author Kevin Seim
 * @since 1.0
 * @see DecimalFormat
...
public class ShortTypeHandler extends NumberTypeHandler {
    ...
    @Override
    protected Short createNumber(String text) throws NumberFormatException {
